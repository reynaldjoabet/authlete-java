...
public class AzureConfiguration {
	...
	@AssertTrue(message = "Either useManagedIdentity must be true, or a connectionString must be provided, "
	...
	public boolean isValidAzureCredentials() {
		if (useManagedIdentity) {
			...
			return StringUtils.isNotBlank(clientId) && StringUtils.isNotBlank(tenantId)
