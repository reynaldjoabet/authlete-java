...
/**
 * Web configuration for security headers. This is a local implementation
 * replacing io.dropwizard.web.conf.WebConfiguration since dropwizard-web is not
 * yet compatible with Dropwizard 5.0.
 */
@Getter
@Setter
