...
import oidc.OidcDiscoveryConfiguration;
import oidc.OidcDiscoveryConfigurationClient;
...
public class StandardOidcIdentityProvider {
	...
	private final OidcDiscoveryConfigurationClient discoveryClient;
	private final OidcTokenValidator tokenValidator;

	public StandardOidcIdentityProvider(String discoveryUrl, List<String> clientIds)
			throws IOException, InterruptedException {
		this.discoveryClient = new OidcDiscoveryConfigurationClient();
		this.tokenValidator = new OidcTokenValidator(discoveryUrl, clientIds);
	}
