...
public class SystemSettings {
	...
	public void initSMTPSettings() {
		if(this.server == null || this.server == "") {
			this.setServer(Utils.getEnv("FACTION_SMTP_SERVER"));
			this.setPort(Utils.getEnv("FACTION_SMTP_PORT"));
			this.setTls(true);
			this.setUname(Utils.getEnv("FACTION_SMTP_USER"));
			this.setFromAddress(Utils.getEnv("FACTION_SMTP_FROM_ADDRESS"));
			this.setPassword(Utils.encryptPassword(Utils.getEnv("FACTION_SMTP_PASSWORD")));
	...
	public void setKeystorePassword(String password) {
		this.keystorePassword = Utils.encryptPassword(password);
	}
	
	public String getKeystorePassword() {
		return Utils.decryptPassword(this.keystorePassword);
	}
	...
	public OidcConfiguration getOdicConfig() {
		...
		config.setSecret(this.oauthClientSecret==null?"":Utils.decryptPassword(oauthClientSecret));
	...
	public void createKeystoreIfNotExists(){
		if(this.keystore == null) {
			try {
				...
				this.keystore = Utils.encryptBytes(keystoreOutput.toByteArray());
			}catch(Exception e) {
	...
	public byte [] getKeyStore() {
		return Utils.decryptBytes(this.keystore);
	}
