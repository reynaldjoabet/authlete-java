...
public class OidcTokenValidator {
  ...
  public OidcTokenValidator(String oidcDiscoveryUrl, List<String> clientIds) throws IOException {
    ...
    clientIds.forEach(
        (id) ->
            validators.put(id, createValidator(config.issuer, config.jwksUri, JWS_ALGORITHM, id)));
  }

  public IDTokenClaimsSet validate(JWT idToken)
  ...
  private IDTokenValidator createValidator(
      String issuerUrl, String jwksUrl, JWSAlgorithm algorithm, String clientId) {
